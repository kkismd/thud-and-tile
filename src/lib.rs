...
use tetromino::{get_srs_wall_kick_offsets_by_shape, Tetromino, TetrominoBag, TetrominoShape}; // CLI版の共通コンポーネントをimport
...
mod web_tetromino_tests {
    ...
    fn test_web_7_bag_system() {
        ...
        let mut test_bag =
            TetrominoBag::new_for_test(RandomProviderImpl::Deterministic(deterministic_provider));
    ...
    fn test_web_adjacency_constraints() {
        ...
        let invalid_tetromino =
            SimpleTetromino::from_shape_with_colors(shape as u8, invalid_colors);
    ...
    fn test_web_cli_tetromino_compatibility() {
        ...
        let web_tetromino =
            SimpleTetromino::from_shape_with_colors(shape as u8, [GameColor::Cyan; 4]);
